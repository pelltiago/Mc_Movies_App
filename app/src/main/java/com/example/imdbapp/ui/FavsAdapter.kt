...
class FavsAdapter(
    ...
    private val moviesList: List<MovieFavModel>,
    ...
    inner class MainViewHolder(itemView: View) : BaseViewHolder<MovieFavModel>(itemView) {
        override fun bind(item: MovieFavModel, position: Int) {
